...
function checkPW() {
   ...
   var p=userInfo.userPassword1.value;
   var cp=userInfo.userPassword2.value;
...
<body>
   ...
   <form method="post" action="joinAction.jsp" id="signupform" class="form-horizontal" role="form" name="userInfo" onsubmit="return checkValue()">
            <br>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-9">
                         <input type="text" class="form-control" name="userID" placeholder="ID" onkeydown="inputIdChk()" id="pInput"> <!--input type="button" value="전달" onclick="setChildText()"-->
                        <input type="button" class="form-control" value="중복 확인" onclick="openIdChk()">
             ...
             <input type="button" class="form-control" value="일치확인" onclick="return checkPW()">
