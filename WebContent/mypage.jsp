			...
			%>
		        <div class="col-lg-4 col-md-6 mb-4">
	              <div class="card h-100">
	                ...
	                <div class="card-body">
	                  <h4 class="card-title">
	                    <a href="detail.jsp?prod_num=<%= lp.getProd_num() %>"><%= sd.getProd_name() %></a><br>
	                    <span class="fa fa-eye" style="margin-right:10px; font-size:13px"><%= sd.getView() %></span>
					    <span class="fa fa-user" style="margin-right:10px; font-size:13px"><%= sd.getLend_count() %></span>
	                  </h4>
	                  <p>판매자 ID: <b><%= sd.getId() %></b></p>
	                  <h6>대여기간:<br><%= lp.getFrom_d() %>~<%= lp.getTo_d() %></h6>
	                  <h6>총 대여료: <%= lp.getPrice1() %>￦</h6>
	                  <h6>보증금: <%= lp.getPrice2() %>￦</h6>
	                  <h6>대여방식: <%= lp.getDelivery() %></h6>
	                </div>
	                <div class="card-footer">
	                  <small class="text-muted">&#9733; &#9733; &#9733; &#9733; &#9734;</small>
