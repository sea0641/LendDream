        		...
        		<div>
        			...
        			<form name=form1 method=post action=lendproduct_control.jsp>
        				<input type="hidden" name="action" value="insert" enctype="multipart/form-data">
        					...
        					<input type=text name=id value=<%= session.getAttribute("userID") %> readonly><br>
        					...
        					<input type=text id=input name=price  style="text-align :right"/>/day<br>
        					...
        					<span style="color:black;font-size:12pt">
        						<select id="category" name="category">
        							...
        							<option value="책">책<br>
        							<option value="옷">옷<br>
        							<option value="잡화">잡화<br>
        						</select>
        					</span><br>
        						
        					<span style="color:grey;font-size:13pt">기간</span><br>
        					<input type="text" value="" id="from" name="from_d" readonly> ~ <input type=text id="to" name="to_d"><br>
        						
        					<span style="color:grey;font-size:13pt">설명</span><br>
        					<textarea name=description placeholder="상품을 설명해주세요." style="width:500px; height:200px; letter-spacing:5px"></textarea><br><br>
