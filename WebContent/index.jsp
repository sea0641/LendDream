...
<head>
	...
	<script>
		...
		function add_dib(n){
			dib += n+",";
			document.getElementById("add_dib"+n).className = "dib2";
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
					            ...
					            %>
					              <div class="col-lg-4 col-md-6 mb-4" style="height:395px;">
					                 <div class="card h-100 pt-5">
					                   ...
					                   <div class="card-body">
					                     <h4 class="card-title">
					                       <a href="detail.jsp?prod_num=<%= sp.getProd_num() %>"><%= sp.getProd_name() %></a><br>
					                       <span class="fa fa-eye" style="margin-right:10px; font-size:13px"><%= sp.getView() %></span>
					                       <span class="fa fa-user" style="margin-right:10px; font-size:13px"><%= sp.getLend_count() %></span>
		            ...
		            %>
		              <div class="col-lg-4 col-md-6 mb-4" style="height:395px;">
		                 <div class="card h-100 pt-5">
		                   ...
		                   <div class="card-body">
		                     <h4 class="card-title">
		                       <a href="detail.jsp?prod_num=<%= dd.getProd_num() %>"><%= dd.getProd_name() %></a><br>
		                       <span class="fa fa-user" style="margin-right:10px; font-size:13px"><%= dd.getLend_count() %></span>
		                       <span class="fa fa-eye" style="margin-right:10px; font-size:13px"><%= dd.getView() %></span>
		  ...
		  <form action="lendproduct_control.jsp" class="search">
      		...
      		<input type="text" placeholder="Search.." name="search" style="margin-right:5px;">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">
                    <a href="detail.jsp?prod_num=<%= lp.getProd_num() %>"><%= lp.getProd_name() %></a><br>
                    <span class="fa fa-eye" style="margin-right:10px; font-size:13px"><%= lp.getView() %></span>
					<span class="fa fa-user" style="margin-right:10px; font-size:13px"><%= lp.getLend_count() %></span>
                  </h4>
                ...
                <div class="card-footer">
                  ...
                  <% } else { %>
						<button class="dib1" onclick="add_dib(<%= lp.getProd_num() %>);" id="add_dib<%= lp.getProd_num() %>" style="float:right;"></button>
                  <% } %>
